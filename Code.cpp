...
public:
Student():Name(""), RollNo(""),CGPA(0.0){} // constructor
...
ofstream out("C:/Code-related/Student.txt", ios::app); // give valid input file
if(!out){ 
...
ifstream in("C:/Code-related/Student.txt");
if(!in){
...
ofstream out("C:/Code-related/Student Temp.txt");
if(!out){
	cout<<"Error:";
out.close();
}
...
out.close();
in.close();
remove("C:/Code-related/Student.txt");
rename("C:/Code-related/Student Temp.txt", "C:/Code-related/Student.txt");
}
